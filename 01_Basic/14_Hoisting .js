...
//  VAR VARIABLE HOISTING (The 'Undefined' Trap)
...
/*
   Engine Visualisation (Behind the scenes):
...
/*
    Deep Concept : "Kya let/const hoist hote hain?" -> YES, hote hain!
...
//  FUNCTIONS HOISTING (Declaration vs Expression)
...
/*
   `testArrow` ek variable hai jiske aage `var` laga hai.
   - Hoisting ke waqt `testArrow` ko default value mili: `undefined`.
   - Jab tumne `testArrow()` likha, toh JS ne dekha `undefined()`, 
